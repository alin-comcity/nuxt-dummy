  ...
  <section class="text-gray-600 body-font">
    <div class="container px-5 py-24 mx-auto">
      ...
      <div class="text-sm text-gray-600 flex items-center gap-2 mb-4">
        ...
        <span>/</span>
        <span class="font-semibold text-gray-800">{{ brandName }}</span>
      </div>
      <!-- /breadcrum -->
        ...
        >
          ...
          <div class="mt-4">
            <NuxtLink :to="`/product/${product.slug}`">
              <h2
                class="text-gray-900 dark:text-gray-200 itle-font text-lg font-medium"
              >
                {{ product.name }}
              </h2>
              <p class="mt-1">
                ...
                <span v-else class="text-xl font-bold dark:text-gray-200"
...
const { data } = await useFetch(
  "https://admindash.comcitybd.com/api/brands/Acer%20Gadget/100?id[]=143"
);
const products = data.value.data;

const brandName = "Cooling Fan";
</script>
